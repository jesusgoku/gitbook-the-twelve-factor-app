...
También es cierto que la aproximación de asignación de puertos ofrece la posibilidad de que una aplicación pueda llegar a ser un [“backing service”](04-backing-services.md) para otra aplicación, usando la URL de la aplicación correspondiente como un recurso declarado en la [configuración](03-configuracion.md) de la aplicación que consume este “backing service”.